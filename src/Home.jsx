...
function Home() {
    ...
    return (
        <div style={{backgroundColor: backgroundColor, height:'100vh' }} className='text-center d-flex justify-content-center align-items-center'>
           <div style={{borderRadius:'10px', maxHeight:'70%'}} className='bg-light p-3 text-center'>
                <h2>Click the button to show your favourite color!!!!</h2>
                <div className='d-flex flex-wrap justify-content-evenly align-items-center gap-3 m-5 w-60'>
